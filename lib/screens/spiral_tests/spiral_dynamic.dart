...
class SpiralDynamic extends StatefulWidget {
  static String id = 'SpiralDynamic';
  @override
  _SpiralDynamicState createState() => _SpiralDynamicState();
}

class _SpiralDynamicState extends State<SpiralDynamic> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Dynamic Spiral Test', style: GoogleFonts.montserrat()),
        leading: IconButton(
                    ...
                    children: <Widget>[
                      Positioned.fill(
                        child: toggleBlink? BlinkWidget(
                          children: <Widget>[
                            SvgPicture.asset('assets/spiral10.svg'),
