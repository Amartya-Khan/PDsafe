...
class WavePhoto extends StatefulWidget {
  const WavePhoto({Key key}) : super(key: key);
  static String id = 'Wave Photo';

  @override
  _WavePhotoState createState() => _WavePhotoState();
}

class _WavePhotoState extends State<WavePhoto> {
    ...
    return Container(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text('Wave Photo Test', style: GoogleFonts.montserrat()),
          leading: IconButton(
