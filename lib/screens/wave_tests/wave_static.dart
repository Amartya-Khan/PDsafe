...
class WaveStatic extends StatefulWidget {
  static String id = 'WaveStatic';
  @override
  _WaveStaticState createState() => _WaveStaticState();
}

class _WaveStaticState extends State<WaveStatic> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Static Wave Test', style: GoogleFonts.montserrat()),
        leading: IconButton(
