...
import 'package:pdsafe_defhacks/ml_models/wave_model.dart';
import 'package:pdsafe_defhacks/widgets/blink_widget.dart';
...
class WaveDynamic extends StatefulWidget {
  static String id = 'WaveDynamic';
  @override
  _WaveDynamicState createState() => _WaveDynamicState();
}

class _WaveDynamicState extends State<WaveDynamic> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Dynamic Wave Test', style: GoogleFonts.montserrat()),
        leading: IconButton(
            ...
            child: RepaintBoundary(
                ...
                child: Container(
                  ...
                  child: Stack(
                    children: <Widget>[
                      Positioned.fill(
                        child: toggleBlink? BlinkWidget(
                          children: <Widget>[
                            SvgPicture.asset('assets/wave-normal-4.svg'),
              ...
              children: [
                ...
                Container(
                  ...
                  child: FlatButton(
                    ...
                    onPressed: () {
                      takeScreenShot();
                      Navigator.pushNamed(context, WaveModel.id);
                    },
                    child: Row(
                      //mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                      children: <Widget>[
